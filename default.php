...
<head>
    ...
    <link href="//db.onlinewebfonts.com/c/007f636c4af6a332a98f32cc3cee8cb4?family=Eurostile+Extended+#2" rel="stylesheet" type="text/css" />
...
<body style="background-image: url(img/concert_bg_2.jpg)" class="imagebg">
    <div class="titol" id="titol">
        <div class="name tracking-in-expand">twenty øne piløts</div>
    </div>
    <div class="tot fade-in2" id="tot">
        ...
        <div class="container  pt-5 mt-5 mb-5 pb-5">
            <div class="container pt-5 mt-5 fadepage imagebg" style="background-image: url(img/concert_bg.jpg)">
                <div class="row">
                    <p class="names1 mt-5 mb-5">We are twenty øne piløts!</p>
                </div>
                <div class="row">
                    <p class="intro mt-5">YOU JUST LANDED ON OUR PAGE</p>
                </div>
                <div class="row">
                    <p class="intro mt-5">WHY DON'T YOU START LISTENING TO OUR MUSIC!</p>
                </div>
                <div class="row">
                    <div class="col-md-6 about mb-5">
                        <a href="/videos.php" target="_self"><input type="button" class="mt-3 ptbtn" value="Listen to our music"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container  pt-5 mt-5 mb-5 pb-5">
            <div class="container fadepage">
                <div class="row">
                    <p class="names1 mt-5 mb-5">øur merch</p>
                </div>
                <div class="row">
                    <div class="col-md-4 shirt"><img src="img/merch_1.png">EMBROIDERED LOGO HOODIE (BLACK)</div>
                    <div class="col-md-4 shirt"><img src="img/merch_2.png">LAUREL RING LONG SLEEVE</div>
                    <div class="col-md-4 shirt"><img src="img/merch_3.png">YELLOW TECH LONG SLEEVE T-SHIRT</div>
                </div>

                <div class="row mt-5">
                    <div class="col-md-6 about mb-5">
                        <a href="https://twentyonepilots.warnerartists.net/es" target="_blank"><input type="button" class="mt-3 ptbtn" value="View full merch"></a>
                    </div>
                </div>
            </div>
        </div>
